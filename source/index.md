...
From there, the {doc}`user guide </user_guide/index>` covers installation in detail and the tutorials, and the {doc}`API reference </api_reference/index>` documents every class the API exposes.
