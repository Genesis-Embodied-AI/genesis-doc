...
Convex detection leans on a precomputed acceleration structure that answers "which vertex lies farthest along a given direction?" in constant time. See {doc}`/user_guide/theory/support_field` for how that field is built and used.
