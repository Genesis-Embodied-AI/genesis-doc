...
The policy outputs neither torques nor absolute joint angles. It outputs a residual around the robot's default standing pose, which `step` scales and adds to that pose to form a position target:
