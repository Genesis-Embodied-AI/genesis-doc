...
- **Render:** three rendering paths that plug in as camera sensors. [Nyx](https://github.com/Genesis-Embodied-AI/genesis-nyx) is an in-house renderer built for robotics, Luisa is a DSL ray tracer, and Pyrender is a rasterizer.
