...
3. **Visibility and purpose.** The parser reads visible prims only. A prim with `purpose = "guide"` stays out of the visuals and may still serve as collision geometry.
