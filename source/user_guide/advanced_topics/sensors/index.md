...
The internal pipeline that produces sensor measurements, and the contract for extending Genesis World with custom sensor types. Read these pages if you are implementing a new sensor or want to understand the abstractions behind `sensor.read()`.
