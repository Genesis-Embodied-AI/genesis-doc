...
Couplers are the bridge between Genesis World solvers, handling forces and interactions between entities simulated by different physical models. Genesis World ships two contact-handling backends with complementary trade-offs:
