...
- **Use the default coupler** ({doc}`Solvers and coupling </user_guide/advanced_topics/solvers_and_coupling>`) for scenes with MPM, SPH, or PBD, for rigid-only simulation, or when you need gradients for differentiable simulation.
