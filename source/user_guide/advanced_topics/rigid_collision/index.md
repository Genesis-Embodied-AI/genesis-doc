...
Rigid-body collision in Genesis World is handled in two distinct phases - first finding which bodies are in contact, then computing the impulses that resolve those contacts. The two pages below describe each phase's algorithmic content.
