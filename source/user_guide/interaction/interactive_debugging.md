...
With `enable_gui=True`, the viewer turns off its help-text overlay and its default keyboard controls, because ImGui captures input that would otherwise conflict with those keybindings.
