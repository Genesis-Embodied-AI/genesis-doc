...
Several standalone scripts at the top level are worth knowing about: `differentiable_push.py` (differentiable simulation), `smoke.py` (Eulerian gas), `ddp_multi_gpu.py` (distributed training across GPUs), and `keyboard_teleop.py` (driving a robot from the keyboard).

A few directories include their own README with setup notes and run commands — read these before diving in:

- [`drone/README.md`](https://github.com/Genesis-Embodied-AI/genesis-world/blob/main/examples/drone/README.md) — control mappings and the full RL train and evaluation workflow.
- [`IPC_Solver/README.md`](https://github.com/Genesis-Embodied-AI/genesis-world/blob/main/examples/IPC_Solver/README.md) — the extra `pyuipc` prerequisite, platform limits, and test cases.
- [`locomotion/backflip/readme.md`](https://github.com/Genesis-Embodied-AI/genesis-world/blob/main/examples/locomotion/backflip/readme.md) — checkpoint download and the backflip training setup.
