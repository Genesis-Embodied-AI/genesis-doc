...
You rarely construct engine objects directly. You describe a scene through options and entities, and `scene.build()` creates the solvers, coupler, and states from them. For how the pieces fit together and the step loop, see {doc}`/user_guide/theory/coupling/index`.
