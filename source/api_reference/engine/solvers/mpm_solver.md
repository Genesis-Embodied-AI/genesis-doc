...
The solver activates when the scene contains an MPM entity. Configure the background grid through the `MPMOptions` documented above. For usage, see {doc}`/user_guide/physics/beyond_rigid_bodies`.
