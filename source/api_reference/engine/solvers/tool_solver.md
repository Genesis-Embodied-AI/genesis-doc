...
The solver activates when the scene contains a tool entity, added with the `gs.materials.Tool` material. Configure it through the `ToolOptions` documented above.
