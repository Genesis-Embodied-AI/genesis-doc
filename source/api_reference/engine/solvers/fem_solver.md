...
The solver activates when the scene contains an FEM entity. Configure it through the `FEMOptions` documented above. For usage, see {doc}`/user_guide/physics/beyond_rigid_bodies`.
