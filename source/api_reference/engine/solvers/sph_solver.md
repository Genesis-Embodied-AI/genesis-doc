...
The solver activates when the scene contains an SPH entity. Configure it through `SPHOptions`; see {doc}`/api_reference/engine/solvers/sph_options` for the full option set. For usage, see {doc}`/user_guide/physics/beyond_rigid_bodies`.
